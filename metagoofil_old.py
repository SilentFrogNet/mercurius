...
print("*                         |___/                                  *")
print("* Metagoofil2 2  v1.0                                             *")
print("* Fork of Christian Martorella's Metagoofil2                      *")
...
def usage():
    ...
    print("         -f: output file\n")
    print(" Examples:")
    print("  metagoofil2.py -d apple.com -t doc,pdf -l 200 -n 50 -o applefiles -f results.html")
    print("  metagoofil2.py -h yes -o applefiles -f results.html (local dir analysis)\n")
    sys.exit()
